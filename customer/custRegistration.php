...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    if (($fullname || $username || $password || $passwordCheck) == "") {
        ...
        $sql = "INSERT INTO customers(fullname,username,password) VALUES ('$fullname','$username','$password')";
...
<body>
    ...
    <div class="container" style="width: 1000px ;">
        <div class="card text-center">
            ...
            <div class="card-body">
                <h5 class="card-title">Customer Register Form</h5>
                <form method="POST">
                    ...
                    <div class="row  text-center">
                        <a class="text-light btn btn-primary" href="../index.php">Back</a>
                    </div>

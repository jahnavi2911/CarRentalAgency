...
<body>
    ...
    <a href="custLogin.php" class="btn btn-primary" style="margin-top:80px; margin-left:20px;">LOGOUT</a>
    <h3 class="text-center" style="color: blue;">Welcome <?php echo $username ?></h3>

...
<body>
    ...
    <a href="index.php" class="btn btn-primary" style="margin-top:80px; margin-left:20px;">BACK</a>
    <h3 class="text-center" style="color: blue;">Available Cars To Rent</h3>
    <div class="container">
        ...
        <div class="row">
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo '
                <div class="col-sm-4">
                <figure class="figure" style="background-color: #d7e4e4; padding: 50px;">
                    <figcaption class="figure-caption">
                        <form method="post">
                            ...
                            <div class="row" style=" margin: 20px;">
                                ...
                                <div class="col"><select id="inputState" disabled>
